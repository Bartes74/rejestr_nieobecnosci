...
**Decyzja o zasięgu urządzeń (uzgodniona z zamawiającym 2026-08-10):** aplikacja jest **desktopowa z dwoma wyjątkami**. NFR-6 w wersji 2.0 dokumentu wymaga interfejsu responsywnego dla desktopu i urządzeń mobilnych; Credit Agricole zaakceptował **wariant pośredni** — **pulpit i formularz wpisu nieobecności działają na telefonie**, pozostałe dziewięć ekranów zakłada stację roboczą. Uzasadnienie: jedyny realny scenariusz mobilny to „zachorowałem, wpisuję z domu"; reszta to narzędzia planistyczne i raportowe używane przy biurku. Próg to 768 px (`apps/web/src/viewport.ts`). Wymaganie „maks. 3 kliknięcia", pochodzące z tego samego NFR-6, **pozostaje wiążące na obu zasięgach**. Zawężenie nie zwalnia z obsługi klawiatury i czytnika ekranu (NFR-7) nigdzie.

**Konsekwencja tej decyzji dla NFR-7 (rozstrzygnięte 2026-08-07, uzgodnione z zamawiającym 2026-08-10):** zasięg desktopowy i pełne WCAG 2.1 AA wykluczają się w **jednym** punkcie — 1.4.10 Reflow, i Credit Agricole zaakceptował jego wyłączenie. Pierwotnie wyłączono także 1.4.4 Resize Text; sprawdzenie przy powiększeniu 200% pokazało, że kryterium jest spełnione, więc wróciło do zakresu. Zawężenie obejmuje wyłącznie 1.4.10 — patrz sekcja o zgodności niżej. Na dziewięciu ekranach desktopowych powłoka ma stały sidebar 250 px, siatki tabel i układy dwukolumnowe nie przelewają się, a poniżej ~1000 px treść przewija się poziomo wewnątrz obszaru głównego. Domknięcie 1.4.10 tam wymagałoby przelewania treści na wszystkich ekranach, czyli rozszerzenia zakresu mobilnego poza uzgodnione dwa. Wybrano zawężenie deklaracji, nie ciche pozostawienie sprzeczności.
...
- reguła przełomu okresu rozliczeniowego (FR-B7) — urlop przechodzi w całości, automatycznie, bez terminu wygaśnięcia; reguła nie jest konfigurowalna;
- **zawężenie NFR-6 i NFR-7 zatwierdzone przez Credit Agricole** — NFR-6 w wariancie pośrednim (pulpit i wpis mobilnie, reszta desktop), NFR-7 bez kryterium 1.4.10 Reflow. Zapis decyzji: `WNIOSEK-ZAWEZENIE-NFR.md`. To już **uzgodniony zakres**, nie propozycja zespołu.
