...
//
// Złamanie linii bierzemy w każdej postaci (CRLF, samotny CR, samotny LF), a nie w samym LF.
// Właściwości oddziela CRLF, więc nazwa z windowsowym „\r\n" gubiła escapowaniem tylko „\n"
// i zostawiała surowy CR w środku wiersza — czyli bajt rozdzielający tam, gdzie ma stać treść.
// CRLF dopasowany przed pojedynczymi znakami, żeby jedno złamanie dało jedno „\n", a nie dwa.
